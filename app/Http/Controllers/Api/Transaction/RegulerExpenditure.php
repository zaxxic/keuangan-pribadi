...
class RegulerExpenditure extends Controller
{
    public function index(Request $request)
    {
        try {
            ...
            //     return [
            //         'id' => $transaction->id,
            //         'attachmentUrl' => asset('storage/reguler_expenditure_attachment/' . $transaction->attachment),
    ...
    public function edit(string $id)
    {
        ...
        if ($transaction->content === 'income') {
            return response()->json(['message' => 'Akses ditolak untuk transaksi jenis pemasukan'], 403);
        }
