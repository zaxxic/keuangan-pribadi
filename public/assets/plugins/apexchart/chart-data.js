...
$(document).ready(function () {
  ...
  if ($("#admin_chart").length > 0) {
    var columnCtx = document.getElementById("admin_chart");
    var columnChart;

    var currentDate = new Date(); // Tanggal saat ini
    var data = {
      daily: generateDataHarian(currentDate, 7), // Mengambil data harian 7 hari terakhir
      weekly: {
        labels: ["Minggu 1", "Minggu 2", "Minggu 3", "Minggu 4"],
        received: [300, 450, 400, 350],
      },
      monthly: {
        labels: [
          "Jan",
    ...
    function generateDataHarian(tanggalSekarang, jumlahHari) {
      var labels = [];
      var received = [];
      var pending = [];

      for (var i = jumlahHari - 1; i >= 0; i--) {
        var tanggal = new Date(tanggalSekarang);
        ...
        // Generate data dummy
        var receivedValue = Math.floor(Math.random() * 100) + 50;
        received.push(receivedValue);
      }
      ...
      series: [
        {
          name: "Net Profit",
          data: [
            10, 15, 12, 8, 20, 18, 14, 16, 11, 10, 15, 12, 8, 20, 18, 14, 16,
            11, 10, 15, 12, 8, 20, 18, 14, 16, 11, 10, 15, 12, 8, 20,
          ],
        },
        {
          name: "Revenue",
          data: [
            20, 25, 22, 18, 30, 28, 24, 26, 21, 20, 25, 22, 18, 30, 28, 24, 26,
            21, 20, 25, 22, 18, 30, 28, 24, 26, 21, 20, 25, 22, 18, 30,
          ],
        },
      ],
      xaxis: {
