                ...
                <div class="card">
                    <div class="card-body">
                        <div class="dash-widget-header">
                            ...
                            <div class="dash-count">
                                <div class="dash-title">Pemsaukan</div>
                                <div class="dash-counts">
                                    <p>21</p>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between flex-wrap flex-md-nowrap">
                                <div class="w-md-100 d-flex align-items-center mb-3 flex-wrap flex-md-nowrap">
                                    <div>
                                        <span>Pemasukan</span>
                                        <p class="h3 text-primary me-5">Rp 10.000.000</p>
                                    </div>
                                    <div>
                                        <span>Pengeluaran</span>
                                        <p class="h3 text-success me-5">Rp 12.000.00</p>
                                    </div>
                                ...
                                <table class="table table-stripped table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Rp 20.000.000</td>
                                            <td>23 Nov 2020</td>
                                            <td><span class="badge bg-success-light">Lunas</span></td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            ...
                                            <td>Rp 45.000</td>
                                            <td>10 Nov 2020</td>
                                            <td><span class="badge bg-warning-light text-warning">Nyicil</span></td>
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    <a href="#" class="action-icon dropdown-toggle"
                                                        data-bs-toggle="dropdown" aria-expanded="false"><i
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html"> Uang nemu</a>
                                                </h2>
                                            </td>
                                            <td>8 Oct 2020</td>
                                            <td>Rp 50.000</td>
