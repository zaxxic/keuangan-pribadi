          ...
          <div class="card-body">
            ...
            <div class="widget settings-menu mb-0">
              <ul>
                ...
                <li class="nav-item">
                  <a href="{{ Route('expenditure_category.index') }}" class="nav-link active">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 32 32">
                      <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4h6v6H4zm10 0h6v6h-6zM4 14h6v6H4zm10 3a3 3 0 1 0 6 0a3 3 0 1 0-6 0" />
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-stripped table-hover datatable">
                  ...
                  <tbody>
                    @foreach ($expenditureCategories as $index => $category)
                    <tr>
                      <td>{{ $index + 1 }}</td>
                      <td>{{ $category->name }}</td>
                      ...
                      <td class="d-flex align-items-center">
                        <div class="dropdown dropdown-action">
                          ...
                          <div class="dropdown-menu dropdown-menu-right">
                            <ul>
                              <li><a class="dropdown-item edit-category-modal" href="#" data-id="{{ $category->id }}" data-name="{{ $category->name }}" data-route="{{ route('expenditure_category.update', $category->id) }}" data-user-id="{{ $category->user_id }}"><i class="far fa-edit me-2 btn-action-icon"></i>Edit</a>
                              </li>

                              <li> <a class="dropdown-item delete-category" href="#" data-id="{{ $category->id }}" data-route="{{ route('expenditure_category.destroy', $category->id) }}" data-toggle="modal" data-target="#deleteCategoryModal">
        ...
        <form id="editCategoryForm">
          ...
          <div class="d-flex mt-3">
            <div class="col-6 me-2">
              <button id="updateCategoryBtn" class="w-100 btn btn-primary paid-continue-btn">Simpan</button>
        ...
        <div class="modal-btn delete-action">
          <div class="row">
            <form id="addIncomeCategoryForm">
              ...
              <input name="name" autofocus placeholder="Masukan kategori yang di iginkan" class="form-control" type="text">
              <div class="d-flex mt-3">
                <div class="col-6 me-2">
...
<script>
  const csrfToken = $('meta[name="csrf-token"]').attr('content');
        ...
        $('#addIncomeCategoryForm').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('expenditure_category.store') }}",
                data: formData,
                success: function(response) {
