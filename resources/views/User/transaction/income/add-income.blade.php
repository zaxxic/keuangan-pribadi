...
@section('content')
<<<<<<< Updated upstream:resources/views/User/transaction/income/add-income.blade.php
...
<div class="page-wrapper">
  <div class="content container-fluid">
    <div class="content-page-header">
      <h5>Tambah Pemasukan</h5>
>>>>>>> Stashed changes:resources/views/User/transaction/add-income.blade.php
    </div>
            ...
            <div class="form-group-item border-0 pb-0">
              <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <div class="form-group">
                    <label>Jumlah </label>
                    <input type="number" name="amount" class="form-control" placeholder="Masukkan jumlah pemasukkan" />
                  </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                  <div class="form-group">
                    <label>Tanggal</label>
                    <input type="date" name="date" class="form-control" placeholder="Tanggal Mulai Pembayaran" />
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6 col-md-12 description-box">
