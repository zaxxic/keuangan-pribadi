                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="widget settings-menu mb-0">
                                <ul>
                                    <li class="nav-item">
                                        <a href="{{ Route('income-admin.index') }}" class="nav-link">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ Route('expenditure-admin.index') }}" class="nav-link active">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                                                viewBox="0 0 32 32">
                                                <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="2"
                ...
                <div class="col-xl-9 col-md-8">
                    <div class="content w-100 pt-0">
                        <div class="d-flex justify-content-between mb-3">
                            <h4 class="mb-0">Kategori Pemasukan</h4>
...
@section('script')
    ...
    <script>
        ...
        $('#addIncomeCategoryForm').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('expenditure-admin.store') }}",
                data: formData,
                success: function(response) {
